...
class _ChatPageState2 extends State<ChatPage2> {
  ...
  void _startNewConversation() async {
    ...
    await _chatService.saveMessageToFirestore(newConversationId,'bot', initialMessage);

    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ChatPage2(conversationID: newConversationId)),
    );
  }
  void _navigateToConversation(String conversationId) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ChatPage2(conversationID: conversationId,)),
    );
  }
  ...
  Widget _buildMessageItem(DocumentSnapshot document) {
    ...
    return Container(
      alignment: alignment,
      child: Column(
        crossAxisAlignment: (data['sender'] == 'user') ? CrossAxisAlignment.end : CrossAxisAlignment.start,
        children: [
          Text(data['text']),
